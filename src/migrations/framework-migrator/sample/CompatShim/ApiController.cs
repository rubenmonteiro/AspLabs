    ...
    public abstract class ApiController : IDisposable
    {
        ...
        public HttpRequestMessage Request
        {
            get
            {
                ...
                {
                    _request = ControllerContext.HttpContext.CreateHttpRequestMessage();
                }
        ...
        public virtual BadRequestObjectResult BadRequest(ModelStateDictionary modelState)
        {
            ...
            return new BadRequestObjectResult(new SerializableError(modelState));
        }
        ...
        /// <summary>
        /// Creates a <see cref="ObjectResult"/> with the specified values.
        /// </summary>
        ...
        [NonAction]
        public virtual ShimJsonResult Json<T>(T content)
        {
            if (content == null)
            {
            ...
            return new ShimJsonResult(content);
        }
        ...
        [NonAction]
        public virtual ShimJsonResult Json<T>(T content, JsonSerializerSettings serializerSettings)
        {
            if (content == null)
            {
                throw new ArgumentNullException(nameof(content));
            ...
            return new ShimJsonResult(content, serializerSettings);
        }
        ...
        /// <returns>A <see cref="JsonResult"/> with the specified values.</returns>
        [NonAction]
        public virtual ShimJsonResult Json<T>(
            T content,
            ...
            Encoding encoding)
        {
            ...
            var result = new ShimJsonResult(content, serializerSettings);
